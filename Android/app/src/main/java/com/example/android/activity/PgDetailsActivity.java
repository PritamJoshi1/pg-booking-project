...
//        intent1.getIntExtra("key2",0);
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(PgDetailsActivity.this,LinearLayoutManager.HORIZONTAL,false);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());

        amenityAdapter = new AmenityAdapter(amenities, PgDetailsActivity.this);
